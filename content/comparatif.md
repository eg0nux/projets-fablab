...
- **Accessibilité** : facilité de mise en œuvre (technique, encadrement, sécurité). *Indicateur inversé* : ★★★★★ = le plus simple à mener.
...
- **Coût matière** : budget de fabrication. *Indicateur inversé* : ★★★★★ = le plus économique (≈ 300 €), ★☆☆☆☆ = le plus coûteux (> 2 000 €).
