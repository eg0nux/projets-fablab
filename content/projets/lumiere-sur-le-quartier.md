...
- Faire découvrir les métiers du bois, du métal, du design d'espace et des collectivités.
- Acquérir des compétences techniques transférables : lecture et réalisation de plans, CAO simple, découpe, assemblage, finitions.
- Travailler la relation « client » : recueillir un besoin, proposer, argumenter, livrer.

## Ce que l'on fabrique
- Bancs et assises en bois massif ou en palettes reconditionnées, jardinières, table de pique-nique.
- Signalétique de quartier : panneaux découpés à la fraiseuse CNC ou au laser, lettrages en vinyle.
- Éclairage solaire low-tech d'appoint pour un cheminement ou un abri.
- Connecteurs, gabarits et prototypes à l'imprimante 3D ; maquette du site à l'échelle.
