...
| ------------------------------- | ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **JetBrains Mono**              | 400, 700                 | titres, logotype, interface, signalétique en capitales espacées, code, tableaux d'en-tête, carte de fabrication, étiquettes des liens (700, 0,92 em) |
...
- les **liens** en étiquettes safran à angles vifs, texte au noir de la page
  ...
  signalétique, pas une emphase —, une étiquette par fragment quand le lien passe à la ligne ; au
